      ...
      <Layout>
        <main className={detailStyles.detail}>
          ...
          <p>
            ...
            <Countdown
              className={detailStyles.detail__countdown}
              date={timer}
              daysInHours={true}
              overtime={true}
            />
          ...
          <div
            id={detailStyles.detail__delay_chart}
            className={detailStyles.detail__chart}
          >
            <DetailDelayGraph
              detailDelayGraph={detailDelayGraph}
              detailDelayGraphMapped={detailDelayGraphMapped}
            />
          </div>

          <p className={detailStyles.detail__comments_title}>
            Is {url} down for you right now? You can submit your comments about
            their service status or report an issue below to let others know
